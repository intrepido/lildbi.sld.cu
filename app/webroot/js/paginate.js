		...
		function() {			
			...
			function fullTable(array, arrayHeaders){				   
					...
					/**** Aqui se llena los th de la tabla *****/
					 ...
					 //Luego que se muestre la tabla completamente entonces se aplican los widgets del tablesorter para que de esta forma tengan efecto los cambios
					$("table").delay(800).fadeIn("", function(){

	...
	public function getById($id = null) {
		...
		if ($this->RequestHandler->isAjax()) {
			...
			if ($this->request->data['value'] != "Archivo de computador" ) {
				...
				if (($this->request->data['value'] == "Material cartográfico") || ($this->request->data['value'] == "Manuscritos de material cartográfico")) {
				...
				else if ($this->request->data['value'] == "Gráficos bidimensionales no proyectables") {

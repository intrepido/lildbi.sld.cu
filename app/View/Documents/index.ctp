				...
				<ul class="nav nav-pills">
					<li class="dropdown"><a href="#" data-toggle="dropdown"
						...
						<ul aria-labelledby="drop4" role="menu" class="dropdown-menu"
							id="menu1">
							<li role="presentation"><?php echo $this->Html->link(__('Con Indezación'), array('action' => 'add', 'con_indizacion'), array('role' => 'menuitem')); ?>
							</li>
							<li role="presentation"><?php echo $this->Html->link(__('Sin Indezación'), array('action' => 'add', 'sin_indizacion'), array('role' => 'menuitem')); ?>
							</li>
						</ul>
					</li>
					<li><?php echo $this->Html->link(__('Listar Analíticas'), array('controller' => 'analitics', 'action' => 'index')); ?>
					</li>
			...
			<div class="container-document-inner">
				...
				<div id="modal-confirmation-delete" class="modal hide fade"
					...
					<div class="modal-body">
						<p>
							<?php echo __('Esta seguro que desea eliminar el documento y todas sus analíticas?'); ?>
						</p>
					</div>

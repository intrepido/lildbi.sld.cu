...
<div>
	...
	<?php echo $this->Form->create('query',array('onsubmit' => 'return validateAdv();')); ?>
       	...
       	<div name="formSearch" class="container-document">
			<legend><?php echo __('Búsqueda Avanzada'); ?></legend>
			<?php if(isset($result)){ ?>
	            <div class="alert">
            ...
            <table class="table-advanced-search">
				<tr>
					<td align="center"><?php echo __('Buscar palabras en un campo específico.'); ?></td>
				</tr>
				<tr>
					<td align="center">
						<div class="input-append">
							...
							<select name="data[query][field]"
								...
								<option value="title"><?php echo __('Título'); ?></option>
			...
			<legend><?php echo __('Restringir Búsqueda'); ?></legend>
			
			<div class="restrict-search row-fluid">	
				<div class="span12">
					<div class="input-prepend">
							<span class="add-on"><?php echo __('Idioma de la publicación:'); ?></span> 
					...
					<div class="input-prepend">				
							<span class="add-on"><?php echo __('País de publicación:')); ?></span>
				...
				<div class="span12">
					...
					<div class="span5"><label style="margin: 0px 95px -8px 0px;">
							<?php echo __('Fecha de Publicación:'); ?></label><br />
					...
					<div align="center" colspan="2">
						<div class="input-prepend">
							<span class="add-on"><?php echo __('Tipo de Literatura:'); ?> </span> <select
								...
								<option value="S"><?php echo __('Documento publicado en una serie periódica'); ?></option>
								<option value="SC"><?php echo __('Documento de conferencia en una serie periódica'); ?></option>
								<option value="SCP"><?php echo __('Documento de proyecto y conferencia en una serie periódica'); ?></option>
								<option value="SP"><?php echo __('Documento de proyecto en una serie periódica'); ?></option>
								<option value="M"><?php echo __('Documento publicado en una monografía'); ?></option>
								<option value="MC"><?php echo __('Documento de conferencia en una monografía'); ?></option>
								<option value="MCP"><?php echo __('Documento de proyecto y conferencia en una monografía'); ?></option>
								<option value="MP"><?php echo __('Documento de proyecto en una monografía'); ?></option>
								<option value="MS"><?php echo __('Documento publicado en una serie monográfica'); ?></option>
								<option value="MSC"><?php echo __('Documento de conferencia en una serie monográfica'); ?></option>
								<option value="MSP"><?php echo __('Documento de proyecto en una serie monográfica'); ?></option>
								<option value="T"><?php echo __('Tesis, Disertación'); ?></option>
								<option value="TS"><?php echo __('Tesis, Disertación que pertenece a una serie	monográfica'); ?></option>
			...
			<div class="form-actions">
				<?php echo $this->Html->link(__('Volver a Búsqueda Simple ').$this->Html->tag('icon',null,array('class'=>'icon-cog')), array( 'action'=>'search'),array('plugin' => false,'class' => 'btn btn-info','escape' => false)); ?>

  ...
  <div class="modal-body">
      <div  class="row-fluid">
        ...
        <?php
			if(isset($doc['v65'])){ 
				echo '<dt>'.__('Año de Publicación').'</dt><dd>'.substr($doc['v65'],0,4).'</dd>';
        	}
		?>
        ...
        <?php
			if(isset($doc['v71'])){ 
				echo '<dt>'.__('Tipo de publicación').'</dt><dd>';
        ...
        <?php
			if(isset($doc['v31'])){ 
				echo '<dt>'.__('Volúmen').'</dt><dd>'.$doc['v31'].'</dd>';
        	}
		?>
        ...
        <?php
			if(isset($doc['v32'])){ 
				echo '<dt>'.__('Número del fasículo').'</dt><dd>'.$doc['v32'].'</dd>';
        	}
		?>
        ...
        <?php
			if(isset($doc['v63'])){ 
				echo '<dt>'.__('Edición').'</dt><dd>'.$doc['v63'].'</dd>';
        	}
		?>
        ...
        <?php
			if(isset($doc['v66'])){ 
				echo '<dt>'.__('Ciudad de publicación').'</dt><dd>'.$doc['v66'].'</dd>';
        	}
		?>
        ...
        <?php
			if(isset($doc['v67'])){ 
				echo '<dt>'.__('País de publicación').'</dt><dd>'.$doc['v67'].'</dd>';
        	}
		?>
        ...
        <?php
			if(isset($doc['v72'])){ 
				echo '<dt>'.__('Número total de citas').'</dt><dd>'.$doc['v72'].'</dd>';
        	}
		?>
        ...
        <?php
			if(isset($doc['v8'][0])){
				echo '<dt>'.__('Dirección electrónica').'</dt><dd>';

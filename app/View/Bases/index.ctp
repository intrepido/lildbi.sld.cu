		...
		<div class="span4">
			<div class="container-document-inner">
				...
				<div class="alert alert-error fade in" id="alert-empty-base"
					style="display: none;">
					<button data-dismiss="alert" class="close" type="button">&times;</button>
					<?php echo __('La base no puede importarse ya que esta no existe o esta vacía en el proveedor'); ?>
				</div>				
			...
			<div class="container-document-inner">
				...
				<div id="modal-confirmation-delete" class="modal hide fade"
					...
					<div class="modal-body">
						<p>
							<?php echo __('Si elimina la base perderá todo los registros que esta contenga. Esta seguro que desea eliminarla?'); ?>
						</p>
					</div>

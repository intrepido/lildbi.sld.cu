...
<div class="well container-search">
	<div class="span9">
		...
		<?php echo $this->Html->link(__('Búsqueda Avanzada ').$this->Html->tag('icon',null,array('class'=>'icon-cog')), array( 'action'=>'advancedSearch'),array('class' => 'btn btn-info','escape' => false)); ?>
		
	</div>
	<div class="span3">
		<div class="input-prepend">
			<span class="add-on"><?php echo __('Resultados por página'); ?></span> <select

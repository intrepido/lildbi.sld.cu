...
<div class="container-document">
	...
	<form accept-charset="utf-8" method="post" id="DocumentAddForm"
		action="/lildbi/analitics/<?php echo isset($typeEditDocument) ? 'edit' : 'add';?>/series_monograficas/<?php echo isset($typeEditDocument) ? $this->Session->read('idEditDocument').'/' : $this->Session->read('idDocument').'/';?>visualization">
		...
		<table class="table table-bordered table-hover inset-type">
			...
			<tbody>
				...
				<tr class="info">
					<td colspan="12" style="border-left-width: 0px; padding-left: 6px;"><div
							class="span5"></div> <b><?php echo utf8_encode(__('Nivel Analítico')) ?>
					</b><a id="next" href="#" class="pull-right"><?php  echo $this->Html->image('next.gif'); ?>
					</a><a id="prev" href="#" class="pull-right"><?php  echo $this->Html->image('prev.gif'); ?>
					</a><a id="bott" href="#" class="pull-right"><?php  echo $this->Html->image('bott.gif'); ?>
					</a><a id="top" href="#" class="pull-right"><?php  echo $this->Html->image('top.gif'); ?>
				...
				<tr>
					<td><?php echo utf8_encode(__('Título')); ?>
						<div class="btn-toolbar">
							<div class="btn-group">
								<?php
								echo $this->element('assistant',array("nameField" => utf8_encode(__('Título')), "numberField" => 12));
								?>
								<a id='cleanField' class="btn" style="padding: 6px 5px 7px;"
									href="#"><i class="icon-remove"></i> </a>
							</div>
					...
					<td>
						<div class='alert alert-error lil' style="display: none;">
							...
							<p>
								...
								'disabled' => true,
								'value'=> '',
								'name'  => 'data[Document][v12]['. utf8_encode(__('Título')) .']',
								'required' => 'true'
				)); ?>
					</td>
				...
				<tr>
					...
					<td><?php echo $this->Form->input('', array(				
							...
							'class' => 'span6',
							'value'=> '',
							'name'  => 'data[Document][v13]['. utf8_encode(__('Título Traducido al Inglés')) .']'
					)); ?></td>
					<td>[13]</td>
				</tr>
				<tr>
					<td><?php echo utf8_encode(__('Páginas')); ?>
						<div class="btn-toolbar">
							<div class="btn-group">
								<?php
								echo $this->element('assistant',array("nameField" => utf8_encode(__('Páginas')), "numberField" => 14));
								?>
								<a id='cleanField' class="btn" style="padding: 6px 5px 7px;"
									href="#"><i class="icon-remove"></i> </a>
							</div>
					...
					<td>
						<div class='alert alert-error lil' style="display: none;">
							...
							<p>
								...
								'disabled' => true,
								'value'=> '',
								'name'  => 'data[Document][v14]['. utf8_encode(__('Páginas')) .']',
								'required' => 'true'
				)); ?>
					</td>

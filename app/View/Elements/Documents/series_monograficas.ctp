...
<div class="container-document">
	...
	<form accept-charset="utf-8" method="post" id="DocumentAddForm"
		action="/documents/<?php echo isset($typeEditDocument) ? 'edit' : 'add';?>/series_monograficas/<?php echo isset($typeEditDocument) ? $this->Session->read('idEdit').'/' : '';?>visualization">
				...
				<tbody>
					...
					<tr>
						...
						<td><div class='alert alert-error lil' style="display: none;">
								...
								<p>
									...
									'rows' => 4,
									'value'=> '',
									'name'  => 'data[Document][v30]['. __('Título') .']',
									'required' => 'true'
							)); ?></td>
					...
					<tr>
						...
						<td><?php echo $this->Form->input('', array(				
								...
								'class' => 'span6',
								'value'=> '',
								'name'  => 'data[Document][v32]['. __('Número del Fascículo') .']'
						)); ?>
						</td>
						<td>[32]</td>
					</tr>
					...
					<tr>
						<td><?php echo __('Título'); ?>
							<div class="btn-toolbar">
								<div class="btn-group">
									<?php
									echo $this->element('assistant',array("nameField" => __('Título'), "numberField" => 18));
									?>
									<a id='cleanField' class="btn" style="padding: 6px 5px 7px;"
										href="#"><i class="icon-remove"></i> </a>
								</div>
						...
						<td>
							<div class='alert alert-error lil' style="display: none;">
								...
								<p>
									...
									'disabled' => true,
									'value'=> '',
									'name'  => 'data[Document][v18]['. __('Título') .']',
									'required' => 'true'
				)); ?>
						</td>
					...
					<tr>
						...
						<td><?php echo $this->Form->input('', array(				
								...
								'class' => 'span6',
								'value'=> '',
								'name'  => 'data[Document][v19]['. __('Título Traducido al Inglés') .']'
						)); ?>
						</td>
						<td>[19]</td>
					</tr>
					<tr>
						...
						<td><div class='alert alert-error lil' style="display: none;">
								...
								<p>
									...
									'class' => 'span6',
									'value'=> '',
									'name'  => 'data[Document][v20]['. __('Páginas') .']',
									'required' => 'true'
							)); ?></td>
					...
					<tr>
						...
						<td><?php echo $this->Form->input('', array(				
								...
								'class' => 'span6',
								'value'=> '',
								'name'  => 'data[Document][v63]['. __('Edición') .']'
						)); ?>
						</td>
						<td>[63]</td>
					</tr>
					<tr>
						...
						<td><div class='alert alert-error lil' style="display: none;">
								...
								<p>
									...
									'class' => 'span6',
									'value'=> '',
									'name'  => 'data[Document][v64]['. __('Fecha de Publicación') .']',
									'required' => 'true'
							)); ?></td>
					...
					<tr>
						...
						<td><div class='alert alert-error lil' style="display: none;">
								...
								<p>
									...
									'class' => 'span6',
									'value'=> '',
									'name'  => 'data[Document][v66]['. __('Ciudad de Publicación') .']',
									'required' => 'true'
							)); ?></td>
					...
					echo $this->Form->input('', array('options' => $resultArray, 'size' => 4, 'style' =>'width: 385px','value'=> '', 'required' => 'true',	'name'  => 'data[Document][v67]['. __('País de Publicación') .']' ));
					?></td>
					...
					<tr>
						...
						<td><?php echo $this->Form->textarea('', array(				
								...
								'rows' => 4,
								'value'=> '',
								'name'  => 'data[Document][v68]['. __('Símbolo') .']'
						)); ?>
						</td>
						<td>[68]</td>
					</tr>
					...
					<tr class="info">
						<td colspan="12" style="padding-left: 5px;"><div class="span5"></div>
							<b><?php echo __('Datos de Contenido')?> </b><a id="next"
									...
									<div class="accordion-inner">
										<table class="table table-bordered">
											...
											<tr>
												...
												<td><div class='alert alert-error lil'
														style="display: none;">
														<button type='button' class='close'>&times;</button>
														<p>
															<?php echo __('Este campo es obligatorio, por favor debe llenarlo'); ?>
					...
					<tr>
						<td colspan="12">
							<div id="accordion2" class="accordion">
								<label class="checkbox"> <input id="proyectNotes"
									type="checkbox"> <?php echo __('Notas de Proyecto') ?>
								</label>

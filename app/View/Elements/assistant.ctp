				...
				<div id="container-field" class="container-document"
					...
					<div id="<?php echo 'repeating-field-v'.$numberField;?>"
						...
						<div class="container-document"
							...
							<div class="row-fluid">
								<?php if($nameField == utf8_encode(__("Localización del Documento"))){?>
								<div id="v<?php echo $numberField;?>">
									<div class="span12" style="margin-left: 6px;">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top" title="<?php echo utf8_encode(__('Código del Centro')); ?>">*</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('Código del Centro')); ?>"
									...
									<div class="span12">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Número de Clasificación')); ?>">a</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('Número de Clasificación')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									</div>
									<div class="span12">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top" title="<?php echo utf8_encode(__('Número de Autor')); ?>">b</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('Número de Autor')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									</div>
									<div class="span12">
									...
									<div class="span12">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top" title="<?php echo utf8_encode(__('Sistema de Empréstito')); ?>">t</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('Sistema de Empréstito')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									</div>
								</div>
								<?php } ?>
								<?php if($nameField == utf8_encode(__("Dirección Electrónica"))){?>
								<div id="v<?php echo $numberField;?>">
									<div class="span12" style="margin-left: 6px;">
										<div class="input-prepend">
									...
									<div class="span12">
										<div class="input-prepend">
											<span class="add-on mandatory" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Código del Idioma')); ?>">i</span>
									...
									<div class="span12">
										<div class="input-prepend">
											<span class="add-on mandatory" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Extensión del Archivo')); ?>">q</span>
											<textarea class="input-xlarge required"
												placeholder="<?php echo utf8_encode(__('Extensión del Archivo')); ?>"
												id="prependedInput"
									...
									<div class="span12">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Nota Pública')); ?>">z</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('Nota Pública')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									</div>
									<div class="span12">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Nota no Pública')); ?>">x</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('Nota no Pública')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									</div>
									<div class="span12">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Tamaño de Archivo')); ?>">s</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('Tamaño de Archivo')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									</div>
									<div class="span12">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Seña')); ?>">k</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('Seña')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									</div>
									<div class="span12">
								...
								<div id="v<?php echo $numberField;?>">
									...
									<div class="span12" style="margin-left: 6px;">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Afiliación')); ?>">1</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('Afiliación')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									</div>
									<div class="span12" style="margin-left: 6px;">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Afiliación')); ?>">2</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('Afiliación')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									...
									<div class="span12" style="margin-left: 6px;">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Afiliación')); ?>">3</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('Afiliación')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									...
									<div class="span12" style="margin-left: 6px;">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top" title="<?php echo utf8_encode(__('País')); ?>">p</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('País')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									</div>
									<div class="span12">
								...
								<?php } ?>
								<?php if($nameField == utf8_encode(__('Título'))){?>
								<div id="v<?php echo $numberField;?>">
									<div class="span12" style="margin-left: 6px;">
										<div class="input-prepend">
											<span class="add-on mandatory" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Título')); ?>">*</span>
											<textarea class="input-xlarge required"
												placeholder="<?php echo utf8_encode(__('Título')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									</div>
									<div class="span12">
								...
								<?php } ?>
								<?php if($nameField == utf8_encode(__('Páginas'))){?>
								<div id="v<?php echo $numberField;?>">
									<div class="span12" style="margin-left: 6px;">
										<div class="input-prepend">
											<span class="add-on mandatory" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Paginación irregular o inexistente')); ?>">*</span>
											<textarea class="input-xlarge required"
												placeholder="<?php echo utf8_encode(__('Paginación irregular o inexistente')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									</div>
									<div class="span12" style="margin-left: 6px;">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Número inicial')); ?>">f</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('Número inicial')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									</div>
									<div class="span12" style="margin-left: 6px;">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Número final')); ?>">l</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('Número final')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									</div>
								</div>
								<?php } ?>
								<?php if($nameField == utf8_encode(__('Información Descriptiva'))){?>
								<div id="v<?php echo $numberField;?>">
									<div class="span12" style="margin-left: 6px;">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Otros detalles físicos')); ?>">b</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('Otros detalles físicos')); ?>"
												id="prependedInput"
												style="overflow: hidden; height: 20px; display: none;"></textarea>
											<select id="conditional-select" name="infDescr"
												...
												<option value="<?php echo $key ?>">
													...
													if(!is_numeric($key)){
														...
														$key == "graf" ? $value = utf8_encode(__('Gráficos')): null;
													}
													echo $value;
													?>
												</option>
									...
									<div class="span12" style="margin-left: 6px;">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Extensión de artículo')); ?>">a</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('Extensión de artículo')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									</div>
									<div class="span12" style="margin-left: 6px;">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Dimensión')); ?>">c</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('Dimensión')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									</div>
									<div class="span12" style="margin-left: 6px;">
										<div class="input-prepend">
											<span class="add-on" data-toggle="tooltip"
												data-placement="top"
												title="<?php echo utf8_encode(__('Material acompañante')); ?>">e</span>
											<textarea class="input-xlarge"
												placeholder="<?php echo utf8_encode(__('Material acompañante')); ?>"
												id="prependedInput" style="overflow: hidden; height: 20px;"></textarea>
										</div>
									</div>
								</div>
